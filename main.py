...
MAIN_MENU_MUSIC = os.path.join(ASSETS_DIR, "MainScreen.wav")
PAUSE_MUSIC = os.path.join(ASSETS_DIR, "Loading_Screen.wav")
GAME_MUSIC = os.path.join(ASSETS_DIR, "8bit-spaceshooter.wav")
